...
import com.lmwis.datachecker.computer.net.proxy.pipe.constant.Constant;
import com.lmwis.datachecker.computer.net.proxy.pipe.enumtype.Protocol;
import com.lmwis.datachecker.computer.net.ssl.HttpSslContextFactory;
...
public class ProxyHandshakeHandler extends SimpleChannelInboundHandler<HttpRequest> {
    ...
    public void channelActive(ChannelHandlerContext ctx) throws Exception {
        // [HTTP] 1.建立front连接
		HttpMessageUtil.InetAddress inetAddr = NettyUtils.toHostAndPort(ctx.channel());
		// init context
