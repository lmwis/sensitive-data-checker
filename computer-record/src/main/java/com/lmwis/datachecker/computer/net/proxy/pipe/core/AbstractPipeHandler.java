...
public abstract class AbstractPipeHandler extends ChannelDuplexHandler {
	...
	protected BackPipe initBackpipe(EventLoopGroup eventLoopGroup, HttpMessageUtil.InetAddress InetAddress) {
	...
	protected abstract BackPipe initBackpipe0(EventLoopGroup eventLoopGroup, HttpMessageUtil.InetAddress InetAddress);
